...
'##########################################################################################################			
	...
	' AJUSTES PDCD MINI 200 A 208	
	If cavity = 203 And fusible$ = "MINI_10" Then
	' AJUSTES MINI10
...
'	If cavity = 204 And fusible$ = "MINI_10" Then
'		' AJUSTES MINI10
'		
'		ajustX = ajustX + .2
'		ajustY = ajustY - 2.2
'	EndIf
'		
'	If cavity = 205 And fusible$ = "MINI_10" Then
'		' AJUSTES MINI10
'		
'		ajustX = ajustX + .2
'		ajustY = ajustY - 2.2
'	EndIf
'		
'	If cavity = 206 And fusible$ = "MINI_10" Then
'		' AJUSTES MINI10
'		
'		ajustX = ajustX + .2
'		ajustY = ajustY - 2.2
'	EndIf
'	
'	If cavity = 207 And fusible$ = "MINI_10" Then
'		' AJUSTES MINI10
'		
'		ajustX = ajustX + 0.3
'		ajustY = ajustY - 2.2
'	EndIf
'	
'	If cavity = 208 And fusible$ = "MINI_10" Then
'		' AJUSTES MINI10
'		
'		ajustX = ajustX + 0
'		ajustY = ajustY - .4
...
'	
	...
	If cavity >= 212 And cavity <= 216 Then
...
' 	If cavity = 205 And fusible$ = "MINI_5" Then
'		' AJUSTES MINI5
'		ajustX = ajustX + .2
'		ajustY = ajustY - 2.2
'	EndIf
'	
'	 If cavity = 206 And fusible$ = "MINI_5" Then
'		' AJUSTES MINI5
'		ajustX = ajustX + .2
'		ajustY = ajustY - 2.2
'	EndIf
'	
'	 If cavity = 207 And fusible$ = "MINI_5" Then
'		' AJUSTES MINI5
'		ajustX = ajustX + .2
'		ajustY = ajustY - 2.2
'	EndIf
...
'		ajustU = ajustU + 0
	...
	If cavity = 305 And fusible$ = "MINI_7.5" Then
			ajustU = ajustU + 1.2
	EndIf
	...
	If caja$ = "PDCD" Then
		If cavity >= 211 And cavity <= 216 Then
			If fusible$ = "ATO_30" Then
