...
Function Toma2Fusible
	...
	'=====================================================================	
	If shared_zone = False Then		' Si el fusible se toma del lado derecho (feeder lineales)
	...
	If shared_zone = True Then	'Si el fusible se toma de lado izquierdo (central, feeder bowl)
